            ...
            <li class="nav-item">
                ...
                <div id="collapseTable" class="collapse" aria-labelledby="headingTable"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('product.create')}}">Addition Product</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTable" class="collapse" aria-labelledby="headingTable"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Action</h6>
                        <a class="collapse-item" href="simple-tables.html">Simple Tables</a>
                        <a class="collapse-item" href="{{route('image-product.index')}}">Image List</a>
                        <a class="collapse-item" href="{{route('image-product.create')}}">Addition Image</a>
                    </div>
                </div>
            </li>
