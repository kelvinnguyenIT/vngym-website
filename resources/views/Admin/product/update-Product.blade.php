...
@section('content')
    ...
    <div class="container-fluid" id="container-wrapper">
        ...
        <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="custom-file">
                                <img src="{{config('constants.url.image-product').$product->image}}" style="height: 80px;width: 80px"/>
                            </div>
                        </div>
            ...
            <div class="col-sm-12">
                <textarea name="editor1">{!! $product->discription !!}</textarea>
                <script>
    ...
    <center style="margin: 2%"><button type="submit" class="btn btn-primary">Update Product</button></center>
    </form>
    <!--Row-->
